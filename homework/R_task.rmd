...
maleFiltered_df <- stat_s_df[stat_s_df$Gender == "male", "Distributions"]
femaleFiltered_df <- stat_s_df[stat_s_df$Gender == "female", "Distributions"]

hist <- plot_ly(alpha = 0.5)

hist <- hist %>% add_histogram(x = maleFiltered_df$Distributions, name = "male")
hist <- hist %>% add_histogram(x = femaleFiltered_df$Distributions, name = "female")
